...
new_answer_templ = 'Нова відповідь' # тк саме для відповідей
...
class AnswerCheck(QuestionView):
    ...
    def check(self):
        ...
        if self.answer.isChecked():
            ...
            self.showed_answer.setText(self.frm_model.answer) # пишемо сам текст відповіді у соотв. віджете
            ...
            self.showed_answer.setText(self.frm_model.answer) # пишемо сам текст відповіді у соотв. віджете
            self.frm_model.got_wrong() # оновити статистику, додавши одну правильну відповідь
